    ...
    <div className="relative min-h-screen w-full flex flex-col">
      ...
      <nav className="relative z-20 flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <Link 
            to="/profile/demo" 
            className="px-4 py-2 text-sm font-medium text-white/80 hover:text-white border border-white/10 rounded-md hover:bg-white/5 transition-colors"
          >
            Demo profile
          </Link>
          <Link 
            to="/register" 
            className="group flex items-center gap-2 px-4 py-2 text-sm font-medium text-white bg-blue-500 hover:bg-blue-600 rounded-md transition-colors shadow-[0_0_15px_rgba(59,130,246,0.5)]"
          >
      ...
      <main className="relative z-10 flex-1 flex flex-col items-center justify-center px-6 mt-[-60px]">
        ...
        <h1 
          ...
          style={{ fontSize: 'clamp(4rem, 15vw, 12rem)', transform: 'scaleX(1.2)' }}
        >
          OMNI
        </h1>
